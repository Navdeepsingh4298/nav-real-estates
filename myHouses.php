...
if($isLoggedIn){
  ...
  $query_str = "SELECT * FROM $tblHouses WHERE uid = '$uid'";
...
<!-- Right Side Content -->
	...
	<h1 class="text-center my-4">My Houses For Sale</h1>
  ...
  <div class="house-list">
		...
		<?php }else { ?>
			<div class="container-fluid lead text-center text-danger my-4">
				<p>No Houses Available.<br> Please Add House for Sale.</p>
			</div>
		<?php } ?>	
